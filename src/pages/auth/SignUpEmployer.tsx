      ...
      <div className="bg-green-600 p-6">
        ...
        {!isLogin && (
          <div className="flex justify-center items-center mt-4 space-x-4">
            ...
            <div
              className={`w-16 h-1 ${step >= 2 ? "bg-white" : "bg-green-400"}`}
            ></div>
            <div
              className={`w-8 h-8 rounded-full flex items-center justify-center ${
                step >= 2
            ...
            <div
              className={`w-16 h-1 ${step >= 3 ? "bg-white" : "bg-green-400"}`}
            ></div>
            <div
              className={`w-8 h-8 rounded-full flex items-center justify-center ${
                step >= 3
              ...
              <div className="space-y-4">
                <div className="bg-gray-50 p-4 rounded-md">
                  ...
                  <div className="mt-2 text-sm text-gray-600 h-40 overflow-y-auto p-2 border border-gray-200 rounded">
                    <p>
                      By signing up for UniJobs as an employer, you agree to our
                      terms of service, privacy policy, and employer code of
